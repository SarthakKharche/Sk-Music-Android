 ...
 */
router.get('/offline-preferences', auth_middleware_1.isAuthenticated, async (req, res) => {
    try {
        const user = req.user;
 ...
 */
router.post('/offline-preferences', auth_middleware_1.isAuthenticated, async (req, res) => {
    try {
...
router.get('/playlists', auth_middleware_1.isAuthenticated, async (req, res) => {
    try {
        ...
        const playlists = snapshot.docs
            .map((doc) => doc.data())
            .filter((playlist) => playlist.id && playlist.id.startsWith('custom_'));
 ...
 */
router.post('/playlists', auth_middleware_1.isAuthenticated, async (req, res) => {
    try {
        const user = req.user;
 ...
 */
router.delete('/playlists/:playlistId', auth_middleware_1.isAuthenticated, async (req, res) => {
    try {
        const user = req.user;
 ...
 */
router.get('/playlists/:playlistId/tracks', auth_middleware_1.isAuthenticated, async (req, res) => {
    try {
        const user = req.user;
        const { playlistId } = req.params;
        const db = (0, firebase_1.getFirestore)();
 ...
 */
router.post('/playlists/:playlistId/tracks', auth_middleware_1.isAuthenticated, async (req, res) => {
    try {
        const user = req.user;
        const { playlistId } = req.params;
 ...
 */
router.delete('/playlists/:playlistId/tracks/:trackId', auth_middleware_1.isAuthenticated, async (req, res) => {
    try {
        const user = req.user;
